...
const SUBJECT_HINTS = {
  ...
  electrical_circuits: ["电路", "电工", "电子", "欧姆", "基尔霍夫", "KCL", "KVL", "RC", "RLC", "circuits", "electronics"],
  signals_systems: ["信号", "系统", "卷积", "傅里叶", "拉普拉斯", "Z变换", "采样", "signals", "systems", "convolution"],
  automatic_control: ["自动控制", "控制系统", "传递函数", "稳定性", "根轨迹", "Bode", "Nyquist", "control systems"],
  thermo_heat_transfer: ["热力学", "传热", "导热", "对流", "辐射", "热阻", "thermodynamics", "heat transfer"],
  computer_science: ["数据结构", "算法", "复杂度", "图算法", "动态规划", "database", "algorithms", "data structures"],
};
